...
public class Respawner : MonoBehaviour
{
    ...
    public int[,] respawn = { 
        ...
        { 1,3,1,3,1,0,0},{ 1,3,2,3,1,0,0},{ 1,3,3,3,1,0,0},{ 1,3,4,3,1,0,0},{ 1,3,5,3,1,0,0},
        { 2,1,0,0,0,0,0 },{ 2,1,0,0,0,0,0 },{ 2,1,2,3,0,0,0 },{ 2,1,2,3,0,0,0 },{ 2,1,5,6,0,0,0 },
        { 2,2,0,0,2,0,0 },{ 2,2,5,0,0,0,0 },{ 2,2,15,0,0,0,0 },{ 2,2,30,0,0,0,0 },{ 2,2,30,0,0,0,0 }
    ...
    void LoadEnemy()
    {
        EnemyList[0] = Resources.Load("Wolf_FB") as GameObject;
        EnemyList[1] = Resources.Load("Bat") as GameObject;
        EnemyList[2] = Resources.Load("Wolf_Boss") as GameObject;
        EnemyList[3] = Resources.Load("Wolf_Boss") as GameObject;
